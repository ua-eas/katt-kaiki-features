...
Feature: Resubmission proposal creation and submission
  ...
  When I start a lookup for "Proposal Development"
  ...
  When I select "view" for the first record
  ...
  When I am on the "Key Personnel" document tab
    ...
    And I should see "Percentage Effort" under "Linda L Garland" set to "5"
    ...
    And I should see "Percentage Effort" under "Amanda F Baker" set to "20"
    And I click "Hide" on the "Amanda F Baker" tab
    And I should see the Combined Credit Split for "Linda L Garland" with the following:
        | Credit for Award | 25 |
        | F&A Revenue      | 25 |
    ...
    And I fill out the Combined Credit Split for "0721 - Cancer Center Division" under "Linda L Garland" with the following:
        | Credit for Award | 30  |
        | F&A Revenue      | 30  |
      And I should see the Combined Credit Split for "Amanda F Baker" with the following:
        | Credit for Award | 75 |
        | F&A Revenue      | 75 |
      And I should see the Combined Credit Split for "0721 - Cancer Center Division" under "Amanda F Baker" with the following:
  ...
  When I am on the "Budget Versions" document tab
    ...
    And I should see "Final?" checkbox unselected
    And I click "Open" on "Final Budget"
  Then I click the "Yes" button
  When I am on the "Parameters" document tab within the Budget Document
    And I fill out the "Budget Periods" table with:
            |  #     | Period Start Date | Period End Date | Total Cost | Direct Cost | F&A Cost |
