...
Feature: proposal creation and submission
  ...
  When I am in the "Document Overview" tab
	  And I set the "Description" to "Garland, NIA, $500,000"
  When I am in the "Required Fields for Saving Document" tab
	  ...
	  And I set the "Project Title" to "Test scenario: create and submit basic proposal"
  ...
  When I am on the "Key Personnel" document tab
    ...
    And I click "Show" on the "Person Details" subsection
    And I set "Percentage Effort" to "20"
