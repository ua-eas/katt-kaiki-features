...
I want to be able to create and submit a renewal proposal using S2S Grants.gov where the grants.gov unit administrator has already been established 

So that the proposal moves thorough the workflow and ends in an "Approved and Submitted" status and the Grants.gov status is Validated.
...
When I set the "Description" to "Garland, NIA, $750,000"
  And I set the "Proposal Type" to "Renewal"
  And I set the "Lead Unit" to "0721"
  And I set the "Activity Type" to "Research"
  And I set the "Project Title" to something like "Test scenario: create and submit renewal proposal"
...
When I set the "Project Start Date" to "02/01/2019"
  ...
  And I set "Award Title" to something like "Test scenario*"
...
When I am on the "Grants.gov" document tab
  And I start lookup for "Grants.gov Lookup"
...
When I am on the "Key Personnel" document tab
  ...
  And I set "Percentage Effort" for "Linda L Garland" to "15"
...
When I click the "Grants.gov" document tab
