...
Federal Sponsor, No Prime, PI/Co-I, Credit Split = One Dept, Predominately 'No' Questions,
Direct/Indirect Budget, No unrecovered F&A, No Cost Share, No Program Income, No Validation Warnings
-- Human Subjects Pending, -- 1 Budget Period
...
When I set the "Description" to "Garland, NIA, $100,000"
  And I set the "Proposal Type" to "Continuation"
  And I set the "Lead Unit" to "0721"
  And I set the "Activity Type" to "Research"
  And I set the "Project Title" to something like "Test scenario: create and submit continuation proposal"
...
When I click "Open Proposal"
Then a new browser window appears

When I click "Proposal" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Grants.gov" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Key Personnel" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Special Review" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Custom Data" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Abstracts and Attachments" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Questions" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Budget Versions" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Permissions" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Proposal Actions" document tab
Then I should see the message "Document was successfully reloaded."

When I click "Medusa" document tab
Then I should see the message "Document was successfully reloaded."