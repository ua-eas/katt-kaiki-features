@PVEN002
  Feature: PVEN002-01 Foreign PO Vendor
  ...
  When I click "Show" on the "Supplier Diversity" tab
    ...
    And I should see the "Active Indicator" checkbox is "checked" in the "New Supplier Diversity" subsection
  ...
  When I click "Show" on the "Address" tab
    ...
    And I should see the "Active Indicator" checkbox is "checked" in the "New Address" subsection
    And I click the "Add" button
  ...
  When I click "Show" on the "Contact" tab
    And I fill out the new Vendor "New Contact" subsection with:
      ...
      | Comments                    | TEST                                |
    And I should see the "Active Indicator" checkbox is "checked" in the "New Contact" subsection
    And I click the "Add" button
  ...
  When I click "Show" on the "Shipping Special Conditions" tab
    ...
    And I should see the "Active Indicator" checkbox is "checked" in the "New Shipping Special Condition" subsection
    And I click the "Add" button
  ...
  When I click "Show" on the "Vendor Phone Number" tab
    ...
    And I should see the "Active Indicator" checkbox is "checked" in the "New Phone Numbers" subsection  
    And I click the "Add" button
    And I click "Hide" on the "Vendor Phone Number" tab
    
  When I click "Show" on the "Notes and Attachments" tab
    And I should see "Posted Timestamp" text set to "document created timestamp"
    And I set "Note Text" to "TEST"
    And I click the "Add" button
